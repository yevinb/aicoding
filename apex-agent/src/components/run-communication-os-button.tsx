...
export function RunCommunicationOsButton() {
  ...
  async function run() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/communication-os", { method: "POST" });
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        {running ? "Running communication cycle..." : "Run communication cycle"}
      </button>
