...
export function RunProspectIntelButton() {
  ...
  async function run() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/prospect-intelligence", { method: "POST" });
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        {running ? "Running intelligence cycle…" : "Run intelligence cycle"}
      </button>
