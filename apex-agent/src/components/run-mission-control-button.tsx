...
export function RunMissionControlButton() {
  ...
  async function run() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/mission-control", { method: "POST" });
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        {running ? "Running autonomous cycle…" : "Run Mission Control cycle"}
      </button>
